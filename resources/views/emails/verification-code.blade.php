...
<head>
    ...
    <title>Mã xác thực Fluid Notes</title>
</head>
        ...
        <tr>
            <td style="padding: 32px 24px;">
                ...
                <p style="margin: 0 0 24px; color: #6b7280; font-size: 14px; line-height: 1.6;">
                    Đây là mã xác thực để hoàn tất đăng ký tài khoản Fluid Notes của bạn. Vui lòng nhập mã bên dưới:
                </p>
                ...
                <div
                    ...
                    <p style="margin: 0; color: #92400e; font-size: 13px;">
                        Mã xác thực sẽ hết hạn sau <strong>5 phút</strong>. Vui lòng không chia sẻ mã này với bất kỳ
                        ai.
                    </p>
                </div>

                <p style="margin: 0; color: #9ca3af; font-size: 13px; line-height: 1.5;">
                    Nếu bạn không yêu cầu mã này, hãy bỏ qua email này. Không ai có thể truy cập tài khoản của bạn mà
