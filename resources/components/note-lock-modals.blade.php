    ...
    <div class="fn-modal-card fn-lock-modal">
        ...
        <div class="fn-modal-body px-4 pb-4 pt-3">
            <form id="unlockNoteForm" onsubmit="submitUnlock(event)" novalidate>
                <div class="mb-3">
                    <label class="form-label fw-semibold small text-secondary" for="unlockPassword">Mật khẩu ghi chú</label>
                    <div class="fn-pw-wrap">
                        ...
                        <button type="button" class="fn-pw-eye" onclick="togglePasswordVisibility('unlockPassword', this)" tabindex="-1">
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    ...
                    <button type="submit" class="btn btn-lock-primary d-inline-flex align-items-center gap-1" id="unlockSubmitBtn">
...
{{-- ══════════════════════════════════════════════
     2. ENABLE LOCK MODAL
══════════════════════════════════════════════ --}}
<div id="enableLockModal" class="fn-modal-overlay" role="dialog" aria-modal="true" aria-labelledby="enableLockModalTitle">
    <div class="fn-modal-card fn-lock-modal">
        ...
        <div class="fn-modal-body px-4 pb-4 pt-3">
            <form id="enableLockForm" onsubmit="submitEnableLock(event)" novalidate>
                <div class="mb-3">
                    <label class="form-label fw-semibold small text-secondary" for="enableLockPassword">Mật khẩu mới</label>
                    <div class="fn-pw-wrap">
                        ...
                        <button type="button" class="fn-pw-eye" onclick="togglePasswordVisibility('enableLockPassword', this)" tabindex="-1">
                            <span class="material-symbols-outlined">visibility</span>
                        </button>
                    </div>
                ...
                <div class="mb-3">
                    <label class="form-label fw-semibold small text-secondary" for="enableLockConfirm">Xác nhận mật khẩu</label>
                    <div class="fn-pw-wrap">
                        ...
                        <button type="button" class="fn-pw-eye" onclick="togglePasswordVisibility('enableLockConfirm', this)" tabindex="-1">
                            <span class="material-symbols-outlined">visibility</span>
                        </button>
                    </div>
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    ...
                    <button type="submit" class="btn btn-lock-primary d-inline-flex align-items-center gap-1" id="enableLockSubmitBtn">
...
══════════════════════════════════════════════ --}}
<div id="changeLockModal" class="fn-modal-overlay" role="dialog" aria-modal="true" aria-labelledby="changeLockModalTitle">
    <div class="fn-modal-card fn-lock-modal">

        <div class="fn-modal-header d-flex align-items-start gap-3 p-4 pb-2">
            <div class="fn-lock-icon-wrap fn-lock-change d-flex align-items-center justify-content-center rounded-3 flex-shrink-0">
        ...
        <div class="fn-modal-body px-4 pb-4 pt-3">
            <form id="changeLockForm" onsubmit="submitChangeLockPassword(event)" novalidate>
                <div class="mb-3">
                    <label class="form-label fw-semibold small text-secondary" for="changeLockCurrent">Mật khẩu hiện tại</label>
                    <div class="fn-pw-wrap">
                        ...
                        <button type="button" class="fn-pw-eye" onclick="togglePasswordVisibility('changeLockCurrent', this)" tabindex="-1">
                            <span class="material-symbols-outlined">visibility</span>
                        </button>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="fn-pw-wrap">
                        <input type="password" id="changeLockNew" class="form-control"
                            placeholder="Ít nhất 6 ký tự" autocomplete="new-password" required minlength="6">
                        <button type="button" class="fn-pw-eye" onclick="togglePasswordVisibility('changeLockNew', this)" tabindex="-1">
                            <span class="material-symbols-outlined">visibility</span>
                        </button>
                    </div>
                ...
                <div class="mb-3">
                    <label class="form-label fw-semibold small text-secondary" for="changeLockConfirm">Xác nhận mật khẩu mới</label>
                    <div class="fn-pw-wrap">
                        ...
                        <button type="button" class="fn-pw-eye" onclick="togglePasswordVisibility('changeLockConfirm', this)" tabindex="-1">
                            <span class="material-symbols-outlined">visibility</span>
                        </button>
                    </div>
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    ...
                    <button type="submit" class="btn btn-lock-primary d-inline-flex align-items-center gap-1" id="changeLockSubmitBtn">
...
══════════════════════════════════════════════ --}}
<div id="disableLockModal" class="fn-modal-overlay" role="dialog" aria-modal="true" aria-labelledby="disableLockModalTitle">
    <div class="fn-modal-card fn-lock-modal">

        <div class="fn-modal-header d-flex align-items-start gap-3 p-4 pb-2">
            <div class="fn-lock-icon-wrap fn-lock-danger d-flex align-items-center justify-content-center rounded-3 flex-shrink-0">
        ...
        <div class="fn-modal-body px-4 pb-4 pt-3">
            <form id="disableLockForm" onsubmit="submitDisableLock(event)" novalidate>
                <div class="mb-3">
                    <label class="form-label fw-semibold small text-secondary" for="disableLockPassword">Mật khẩu hiện tại</label>
                    <div class="fn-pw-wrap">
                        ...
                        <button type="button" class="fn-pw-eye" onclick="togglePasswordVisibility('disableLockPassword', this)" tabindex="-1">
                            <span class="material-symbols-outlined">visibility</span>
                        </button>
                    </div>
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    <button type="button" class="btn btn-light" onclick="closeLockModal('disableLockModal')">Huỷ</button>
                    <button type="submit" class="btn btn-lock-danger d-inline-flex align-items-center gap-1" id="disableLockSubmitBtn">
